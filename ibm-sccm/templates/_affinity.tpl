...
*/
{{- define "ibm-sccm.nodeAffinity" }}
{{- $rootCtx := index . 0 }}
{{- $currNodeAffinity := index . 1 }}
{{- $archRequiredMatchExpressions := include "ibm-sccm.nodeAffinityArchRequired.matchExpressions" $rootCtx }}
nodeAffinity:
...
*/
{{- define "ibm-sccm.nodeAffinityArchRequired.matchExpressions" }}
...
/*
  Pod Anti Affinity
*/
{{- define "ibm-sccm.podAntiAffinity" }}
{{- $rootCtx := index . 0 }}
