...
if supports_scc; then
    ...
    kubectl delete -f ../../pre-install/clusterAdministration/ibm-sccm-scc.yaml
    isApplied=true
fi
...
if supports_psp; then
    if [ "$isApplied" == "false" ]; then
       ...
       kubectl delete -f ../../pre-install/clusterAdministration/ibm-sccm-psp.yaml
       echo "Deleting ClusterRole"
       kubectl delete -f ../../pre-install/clusterAdministration/ibm-sccm-cr.yaml
    fi
fi
